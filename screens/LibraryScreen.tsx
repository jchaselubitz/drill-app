...
const LibraryScreen: React.FC = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.subtitle}>Manage the vocabulary and grammar concepts you want to review.</Text>
          ...
          library.terms.map((item) => (
            <TouchableOpacity key={item.value} style={styles.entry}>
              <View>
                ...
                {item.translation ? <Text style={styles.entryTranslation}>{item.translation}</Text> : null}
              </View>
